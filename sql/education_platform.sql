...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='作业或考试表';

/*Data for the table `assignment` */

insert  into `assignment`(`id`,`title`,`course_id`,`user_id`,`type`,`description`,`start_time`,`end_time`,`create_time`,`status`,`update_time`,`mode`) values (9,'测试1',9,6,'exam','测试1的说明','2025-07-01 14:00:00','2025-07-01 16:00:00','2025-07-01 14:53:32',0,'2025-07-01 19:05:33','question'),(15,'12',9,3,'exam','132','2025-07-01 00:00:00','2025-07-01 01:00:00','2025-07-01 18:19:09',0,'2025-07-01 18:19:09','question'),(17,'作业2',9,3,'homework','','2025-07-01 00:00:00','2025-07-01 01:00:00','2025-07-01 18:41:05',0,'2025-07-02 01:04:02','file'),(20,'测试2',9,6,'exam','','2025-07-01 01:00:00','2025-07-01 02:00:00','2025-07-01 19:05:51',0,'2025-07-01 19:05:59','question'),(21,'2',9,6,'exam','','2025-07-03 20:06:14','2025-07-03 21:00:00','2025-07-01 19:06:23',0,'2025-07-01 21:03:33','question'),(23,'3232',9,3,'homework','','2025-07-02 23:56:06','2025-07-03 23:07:00','2025-07-01 23:55:16',0,'2025-07-01 23:55:42','question');
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='作业题目关联表';

/*Data for the table `assignment_question` */

insert  into `assignment_question`(`id`,`assignment_id`,`question_id`,`score`,`sequence`) values (18,9,13,5,1),(19,9,17,5,2),(20,9,12,5,3),(21,9,12,0,4),(22,21,13,5,1),(23,21,17,5,2),(28,17,13,5,1),(29,17,12,5,2);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='作业提交记录表';

/*Data for the table `assignment_submission` */

insert  into `assignment_submission`(`id`,`assignment_id`,`student_id`,`status`,`score`,`feedback`,`submit_time`,`grade_time`,`graded_by`,`content`,`create_time`,`update_time`) values (4,23,12,1,NULL,NULL,'2025-07-02 00:21:05',NULL,NULL,'这是学生提交的作业内容','2025-07-02 00:21:05','2025-07-02 00:21:05'),(5,23,12,2,85,'做得不错，但有些地方需要改进','2025-07-01 23:21:05','2025-07-02 00:21:05',3,'这是另一个学生提交的作业内容','2025-07-02 00:21:05','2025-07-02 00:21:05');
...
insert  into `chapter`(`id`,`course_id`,`title`,`description`,`sort_order`,`create_time`,`update_time`) values (11,9,'绪论','这是一个绪论',1,'2025-06-29 16:22:39','2025-06-29 21:52:09'),(12,9,'第一章','',2,'2025-06-29 21:07:41','2025-06-29 21:07:41');
...
insert  into `course_class`(`id`,`course_id`,`teacher_id`,`name`,`description`,`is_default`,`create_time`) values (10,9,6,'软件工程2306班','123',0,'2025-07-02 14:08:30'),(12,20,6,'软件工程2307班','',0,'2025-07-02 14:50:18'),(16,20,6,'软件工程2308班','',0,'2025-07-02 15:24:03');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程资源表';

/*Data for the table `course_resource` */

insert  into `course_resource`(`id`,`course_id`,`name`,`file_type`,`file_size`,`file_url`,`description`,`download_count`,`upload_user_id`,`create_time`,`update_time`) values (1,9,'1','pdf',325858,'/files/resources/9/202506/7acbf820bec64795bedaca556c235c4a.pdf','1',4,6,'2025-06-30 16:18:14','2025-06-30 16:18:14');
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程小节表';

/*Data for the table `section` */

insert  into `section`(`id`,`chapter_id`,`title`,`description`,`video_url`,`duration`,`sort_order`,`create_time`,`update_time`) values (14,11,'111','111','202506/d8f77cf2-597d-48d9-bc78-7010e3a915ec.mp4',30,1,'2025-06-30 12:33:31','2025-06-30 12:33:43'),(15,11,'222','222',NULL,30,2,'2025-06-30 14:23:30','2025-06-30 14:23:30');
...
insert  into `user`(`id`,`username`,`password`,`email`,`real_name`,`avatar`,`role`,`status`,`create_time`,`update_time`) values (1,'admin','$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsNSEYy4k4onaZDe17ZOS','admin@example.com','系统管理员',NULL,'ADMIN','ACTIVE','2025-06-29 02:09:12','2025-06-29 02:09:12'),(2,'teacher1','$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsNSEYy4k4onaZDe17ZOS','teacher1@example.com','张教授',NULL,'TEACHER','ACTIVE','2025-06-29 02:09:12','2025-06-29 02:09:12'),(3,'teacher2','$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsNSEYy4k4onaZDe17ZOS','teacher2@example.com','李教授',NULL,'TEACHER','ACTIVE','2025-06-29 02:09:12','2025-06-29 02:09:12'),(6,'test01','$2a$10$yinM6zXGIZ7AWSXA8QquqOE6v28EEcb7hpaOoz53ikmbV7bT8jWJe','2825507827@qq.com','测试教师',NULL,'TEACHER','ACTIVE','2025-06-29 02:12:20','2025-06-29 02:12:20'),(7,'test02','$2a$10$KoS8uj6MG4W.9W3lRL78yuFtC9rYZmFbQIxX/BmIX7nAJLkfME7he','2825507825@qq.com','测试教师',NULL,'TEACHER','ACTIVE','2025-06-29 12:29:23','2025-06-29 12:29:23'),(9,'th1','$2a$10$jkqmHsAkW.soiGElTZyk8OU2mC6YEUxCWizcgGsOly2wfQGljHY6.','28254437825@qq.com','测试',NULL,'TEACHER','ACTIVE','2025-06-29 18:16:10','2025-06-29 18:16:10'),(12,'stu01','$2a$10$hwXoEKCcsQXLLSM5AoHPh.qvWzWSKalBGq8XcCNxSsWMCy.9CQHvS','20234042@stu.neu.edu.cn','测试学生',NULL,'STUDENT','ACTIVE','2025-07-01 21:05:06','2025-07-01 21:05:06');
